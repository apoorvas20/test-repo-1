...
Adding a new image. Testing that edits from github prerserve the image in Falconer. We will try this agin. lets see if images are preserved when doc isnt open? 
